        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(147,51,234,0.5)] group-hover:shadow-[0_0_25px_rgba(147,51,234,0.8)] overflow-hidden">
              ...
              <Sparkles className="absolute top-2 right-2.5 w-2 h-2 text-white animate-pulse" style={{ animationDelay: '0.2s' }} />
              <Sparkles className="absolute bottom-3 left-3 w-1.5 h-1.5 text-white/80 animate-pulse" style={{ animationDelay: '0.4s' }} />
              <Sparkles className="absolute top-3 left-2.5 w-1 h-1 text-white/90 animate-pulse" style={{ animationDelay: '0.6s' }} />
            </div>
