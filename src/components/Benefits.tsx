    ...
    <section id="benefits" className="py-24 px-6 bg-muted/30">
      <div className="container mx-auto">
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-3xl font-bold text-primary mb-3">{benefit.stat}</p>
        ...
        <div className="mt-16 text-center">
          <p className="text-sm text-muted-foreground">Powered by AI to understand your unique patterns and needs</p>
        </div>
      </div>
    </section>
  );
